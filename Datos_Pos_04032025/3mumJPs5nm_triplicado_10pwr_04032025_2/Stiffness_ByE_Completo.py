...
C=k_B*T
bins=20
N=3             #Número de experimentos para las k's promedio
...
lista_archivos=glob.glob('C:/Users/PC/OneDrive/Desktop/Datos_Pos_04032025/3mumJPs5nm_triplicado_10pwr_04032025_2/*.txt')  #Cargamos todos los archivos *.txt a la variable "lista_archivos", modificar el path si es necesario
...
with pd.ExcelWriter("3mumJPs5nm_triplicado_10pwr_04032025_2.xlsx") as writer:
