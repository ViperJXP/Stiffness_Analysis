...
lista_archivos=glob.glob('C:/Users/PC/OneDrive/Desktop/Datos_Pos_04032025/3mumJPs5nm_triplicado_15pwr_04032025_1/*.txt')  #Cargamos todos los archivos *.txt a la variable "lista_archivos", modificar el path si es necesario
...
with pd.ExcelWriter("3mumJPs5nm_triplicado_15pwr_04032025_1.xlsx") as writer:
